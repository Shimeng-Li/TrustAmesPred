...
data_args = {'train_file': '../dataset/ames/data_v2/train_baseline.csv',
             ...
             'train_cache_file_path': './data_transform/multi_initial_train.bin',
             'test_cache_file_path': './data_transform/multi_initial_ext.bin',
             'task_name': ['ames'],
             'num_workers': 20,
             'random_state': 0,
...
model_args = {'param_path': './gat_result/param_opt/param_opt_v3/test_opt',
              'result_path': './gat_result/uncertainty_estimation/multi_initial',
...
test_score_list = []
for t_i in range(model_args['train_times']):
    dir_name = model_args['result_path'] + '/model_' + str(t_i + 1)
    mkdir_p(dir_name)
